...
export const BookCard = ({ book }) => {
    return (
        ...
        <Card className="bookCard" border={"3px solid rgba(168, 242, 210, 0.8)"} mt={"20px"} maxW='sm' boxShadow="rgba(168, 242, 210, 0.8) 0px 30px 60px -12px inset,rgba(168, 242, 210, 0.8) 0px 18px 36px -18px inset" >
            <CardBody>
                ...
                <Stack mt='6' spacing='3'>
                    <Heading size='md'>{book.book_name}</Heading>
                    <Heading size='md'>Author: {book.author}</Heading>
                    {/* <Heading size='md'>Category: {book.category}</Heading>
      <Heading size='md'>Year: {book.release_year}</Heading> */}
                    {/* <Text>
